...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT(
        ...
        KC_LSFT, KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_UP, KC_COPY,
        KC_LCTL, KC_LGUI, KC_LALT,                   KC_SPC,  TG(1),  KC_SPC,           KC_RALT, KC_PSCR, KC_LEFT, KC_DOWN,   KC_RGHT
    ),
