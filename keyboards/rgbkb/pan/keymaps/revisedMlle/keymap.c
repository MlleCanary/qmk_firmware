...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_all(
        ...
        RGB_VAD,   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,   KC_H,   KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,
        KC_LSFT,   KC_BSLS, KC_Z,    KC_X,    KC_C,    KC_V,   KC_B,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC,
        KC_LCTL,   KC_LGUI, KC_LALT, RGB_TOG, MO(_ADJ),TO(_ADJ), KC_SPC, KC_SPC, KC_LEFT, KC_DOWN, KC_SLSH,   KC_DEL
    ),
