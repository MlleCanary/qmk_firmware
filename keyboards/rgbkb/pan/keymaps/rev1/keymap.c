...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_all(
        ...
        KC_LSFT,   KC_Z, KC_X,    KC_C,    KC_V,    KC_B,   KC_N,   KC_M,    KC_COMM,    KC_DOT, KC_SLSH,  KC_, KC_RSPC,
        KC_LCTL,   KC_LGUI, KC_LALT, KC_SPC, KC_SPC, TG(_ONE), KC_SPC, MO(_FN), KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT
    ),
