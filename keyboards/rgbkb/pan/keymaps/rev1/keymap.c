...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_all(
        ...
        KC_LSFT,   KC_Z,   KC_X,     KC_C,    KC_V,    KC_B,   KC_N,   KC_M,    KC_COMM, KC_DOT, KC_SLSH,  KC_QUOT, _______,
        KC_LCTL,   KC_LGUI, KC_LALT, KC_SPC, KC_SPC, KC_SPC, KC_SPC, KC_SPC, KC_LEFT, KC_QUOT, KC_QUOT,   KC_DEL
    ),
    ...
    [_ONE] = LAYOUT_all(
        ...
        KC_LCTL,   KC_LGUI, KC_LALT, RGB_TOG, TG(_ONE),KC_SPC, KC_SPC, MO(_FN), KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT
    ),
    ...
    [_ADJ] = LAYOUT_all(
        ...
        _______, _______, _______, RGB_MOD, TG(_BASE), _______, _______, KC_P0,   KC_PDOT, KC_NLCK, _BASE, _ONE
    )
};
